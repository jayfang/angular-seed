...
controller('DevEnvironment', ['$scope', 'roomState',
    function (sc, rs) {
...
.controller('EmptyList', ['$scope', 'roomState',
    function (sc, rs) {
        sc.present = [];
        sc.addUser = function () {
    ...
    .controller('NegativePeople', ['$scope', 'roomState',
        function (sc, rs) {
            sc.present = {
                length: -1
            };
    ...
    .controller('LongList', ['$scope', 'roomState',
        function (sc, rs) {
            var listLength = 50;
            sc.present = [];
    ...
    .controller('PeopleFromService', ['$scope', 'roomState',
        function (sc, rs) {
